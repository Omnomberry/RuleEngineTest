...
public class ComplexityFields {
    ...
    public static final String GICOMP = getNextID()
            + ", 'GI-complete', 'GIC', 3";

    public static final String NPCOMP = getNextID()
            + ", 'NP-complete', 'NPC', 4";

    public static final String NPHARD = getNextID() + ", 'NP-hard', 'NPH', 4";

    public static final String CONPCOMP = getNextID()
            + ", 'coNP-complete', 'coNPC', 4";
    ...
    public static final String CONPCOMPS = getNextID()
            + ", 'coNPC', 'coNPC', 4";
